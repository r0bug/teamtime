<script lang="ts">
	...
	$: navItems = [
			...
			{ href: '/floorplan', label: 'Floorplan', icon: 'map', show: mod('floorplan') },
	...
	$: adminSections = [
		...
		},
		{
			...
			items: [
				...
				{ href: '/admin/social-media', label: 'Social Media', icon: 'share', show: true },
		...
		},
		{
			...
			items: [
				...
				{ href: '/admin/pricing/grading', label: 'Pricing Grading', icon: 'grade', show: true },
		...
		},
		{
			...
			items: [
				...
				{ href: '/admin/sms', label: 'SMS', icon: 'phone', show: isAdmin },
	...
	function getIcon(iconName: string): string {
		const icons: Record<string, string> = {
			...
			'trophy': 'M5 3h14v2H5V3zm0 4h14l-2 7H7L5 7zm2.5 9h9l.5-2H7l.5 2zM9 18h6v2H9v-2z',
			...
			'correlation': 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
