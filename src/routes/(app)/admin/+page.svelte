...
<div class="p-4 lg:p-8 max-w-7xl mx-auto">
	...
	<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
		...
		<a href="/admin/vendors" class="card hover:shadow-md transition-shadow">
			<div class="card-body flex items-center">
				...
				<div>
					<h3 class="font-semibold text-gray-900">Vendors</h3>
					<p class="text-sm text-gray-600">Booth vendors, agreements, and sales</p>
				</div>
			</div>
		</a>

		<a href="/admin/vendor-agreements/templates" class="card hover:shadow-md transition-shadow">
			<div class="card-body flex items-center">
				...
				<div>
					<h3 class="font-semibold text-gray-900">Agreement Templates</h3>
					<p class="text-sm text-gray-600">Manage rental and add-on agreement docs</p>
				</div>
			</div>
		</a>
		...
		<a href="/admin/ebay-setup" class="card hover:shadow-md transition-shadow">
			<div class="card-body flex items-center">
				...
				<div>
					<h3 class="font-semibold text-gray-900">eBay Setup</h3>
					<p class="text-sm text-gray-600">Consignor rates & lister commissions</p>
				</div>
			</div>
		</a>

		<a href="/admin/commissions" class="card hover:shadow-md transition-shadow">
			<div class="card-body flex items-center">
				<div class="w-12 h-12 bg-amber-100 rounded-lg flex items-center justify-center mr-4">
					<svg class="w-6 h-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
				...
				<div>
					<h3 class="font-semibold text-gray-900">eBay Commissions</h3>
					<p class="text-sm text-gray-600">Listing-agent payouts by pay period</p>
				</div>
			</div>
		</a>
