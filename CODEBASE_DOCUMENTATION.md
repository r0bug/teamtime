...
- **Schema File**: `src/lib/server/db/schema.ts` (1,463 lines)
- **Tables**: 50+ tables across 10 domains
...
| Agent | Purpose | Tools |
|-------|---------|-------|
| **Office Manager** | Staff management, scheduling, tasks | 16 tools |
| **Revenue Optimizer** | Analytics, patterns, recommendations | 3 tools |
...
*Documentation generated by comprehensive codebase analysis. Last updated: December 11, 2025*
